...
class PianoKeyboard extends Component {
	...
	render() {
		const extraBorder = {
			"borderLeftWidth": this.props.remainingSpace + "px",
			"borderRightWidth": this.props.remainingSpace + "px"
		};

		const classMod = this.props.isActive ? "--on" : "";

		return (
			<div className={"piano__keys" + classMod} 
					style={extraBorder}>
